<?php
	...
	if(isset($_SESSION['logged_in'])) 
	{
        if(isset($_POST['id'])) {
                $id = $_POST['id'];
                $query = $pdo->prepare('DELETE FROM topics WHERE id = ?');
                    ...
                    <div id="nav-container">
                        <div id="profile" class="clearfix">
                         ...
                         <ul id="navi">
                            ...
                            <li>
                              <a href="delete.php" class="currentmenu"><div class="text">Delete Topic</div></a>
                            </li>
                            <li>
										...
										?>	
											...
											?>	<div class="accordion-group">
													<div class="accordion-heading">
														<button class="last btn btn-danger " type="submit" name="id" value="<?php echo $topic['id'];?>" >Delete</button>
