...
<head>
		<title>:: <?php echo $_SESSION['username']; ?> :: Moderator panel ::</title>
	...
	else
	{
		if(isset($_POST['username'], $_POST['password']))
		{
			...
			{
				$query = $pdo -> prepare("SELECT * FROM moderators WHERE username = ? AND password= ?");
...
?>
		...
		<html lang="en">
			<head>
				<title>:: Login :: Moderator panel ::</title>
				<meta charset="utf-8">
			...
			<body>
				<div class="container-fluid">
					<div class="row-fluid">
					  ...
					  <?php } ?>
					  		<p style="text-align:center;color:#0099cc;margin-bottom:-40px;"><b>Moderator Panel</b></p>
