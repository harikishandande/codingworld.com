			...
			<div class="row-fluid">
				<div class="span12">
					<ul class="nav nav-tabs">	 
						<li><a href="addlpsubject.php"><i class="icon-plus"></i>Add Lab Subject</a></li>
						<li><a href="lpsubjects.php"><i class="icon-plus-sign"></i>Add Aim</a></li>
						<li><a href="lpsubjectsview.php"><i class="icon-remove-sign"></i>Delete lab subject & programs</a></li>
						<li><a href="lpsubjectsvalidation.php"><i class="icon-ok-sign"></i>Programs validation</a></li>
					</ul>
				</div>
			</div>
		</div>
